<template>
	<view class="uni-forms-item"
		:class="['is-direction-' + localLabelPos ,border?'uni-forms-item--border':'' ,border && isFirstBorder?'is-first-border':'',msg?'uni-forms-items':'']">
		<!-- msg?'uni-forms-items':''新增的内容 -->
		<slot name="label">
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 处理 label 位置
			_labelPosition() {
				if (this.labelPos) return this.labelPos

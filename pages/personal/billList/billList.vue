	...
	<view>
		...
		<view class="bg-white" style="position: fixed;width: 100%;z-index: 1;">
			...
			<view class="status mt-1">
				<uni-segmented-control :current="active2" :values="activeList2" @clickItem="search2" activeColor="#68DAB3" unchecked="#8B8B8B"></uni-segmented-control>
			</view>
		</view>
		<view style="height: 160rpx;"></view>
		<!-- 订单列表 -->
		<billListSon :dataList="4" :active="active1"></billListSon>
		<uni-load-more :status="status" />
	</view>
</template>

<script>
	import billListSon from "./components/billListSon"
	export default {
		name: '',
		components: {
			billListSon

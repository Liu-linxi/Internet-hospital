	...
	<view>
		<view class="mx-3 pt-3 pb-14">
			<view class="d-flex a-center">
				...
				<text class="ml-1 font-weight">自取订单信息</text>
			</view>
			<!-- 配送显示内容 -->
			<public-delivery v-show="stateType=='配送'" :stateDelivery="stateDelivery" :status="status"></public-delivery>	
			<public-item :status="status"></public-item>
		</view>
		<public-buttons :stateType="stateType" :status="status" :model='0' @toPay="toPay" @toCancel="toCancel"  @toEvaluate="toEvaluate" @toConsult="toConsult"></public-buttons>
	</view>
</template>
